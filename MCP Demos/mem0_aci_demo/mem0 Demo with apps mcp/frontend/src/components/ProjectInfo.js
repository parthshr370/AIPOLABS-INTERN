...
function ProjectInfo({ onPromptClick }) {
  const capabilities = [
    ...
    {
      name: 'Web Search + Memory',
      prompt: 'Search for the latest news about AI agents and store the key findings in my memory for future reference.',
    },
    {
      name: 'Dynamic Tool Discovery',
      prompt: 'I need to send an email about my travel memories to a friend. Find the right tools and help me compose and send it.',
    },
  ];
  ...
  return (
    <div className="project-info">
      ...
      <h1 className="title">ACI.DEV MEM0<br />Memory Buddy</h1>
      ...
      <p className="description">
        A powerful memory management demo using ACI.dev's Unified MCP Server with dynamic function discovery and MEM0 integration. This agent can discover and use 600+ tools on-demand. Select a capability below to generate a sample prompt.
      </p>
