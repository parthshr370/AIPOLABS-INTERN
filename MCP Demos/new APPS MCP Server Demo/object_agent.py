...
async def main():
    ...
    system_message_content = (
        ...
        "- **MEM0 Tools:** For memory operations (storing, retrieving, updating, deleting personal information) - always use user_id 'your_user_id' "
        ...
        "Always ensure that all MEM0 tool calls include the user_id 'your_user_id' parameter. Be proactive in using the right tools for each user request."
    )
